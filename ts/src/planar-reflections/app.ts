...
const root = 'away3d/PlanarReflections/'; const [obj, image, sand] = await Promise.all([fetch(`${root}R2D2.obj`).then((r) => r.text()), loadImageResourceFromUrl(`${root}r2d2_diffuse.jpg`), loadImageResourceFromUrl(`${root}desertsand.jpg`)]);
